...
class Mixup(ContinualModel):
    ...
    def __init__(self, model, loss, args, len_train_lodaer, transform):
        super(Mixup, self).__init__(model, loss, args, len_train_lodaer, transform)
    ...
    def observe(self, inputs1, labels, inputs2, notaug_inputs):
        ...
        if self.buffer.is_empty():
            if self.args.cl_default:
                ...
                data_dict['loss_info'] = data_dict['loss_info'].mean()
